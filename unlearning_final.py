...
def create_dataloader_from_parquet(tokenizer, parquet_file, batch_size, shuffle=True, max_length=128):
    """
...
def unlearn(input_model_path, retain_set, forget_set, output_model_path):
...
if __name__ == "__main__":
    ...
    unlearn(args.input_model_path, args.retain_set, args.forget_set, args.output_model_path)